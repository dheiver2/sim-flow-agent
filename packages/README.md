...
This directory contains the official SDKs for [Mangaba Flow](https://sim.ai), allowing developers to execute workflows programmatically from their applications.
...
1. Logging in to your [Mangaba Flow](https://sim.ai) account
